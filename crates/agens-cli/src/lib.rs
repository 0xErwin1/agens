...
use agens_providers::chatgpt_login::{
    LoginCancellation, remove_provider_entry, upsert_provider_entry,
};
use agens_providers::{
    ChatGptAuthState, DiagnosticRef, ProviderDiagnosticKind, load_chatgpt_auth_state,
};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
...
use agens_tui::{
    ...
    SessionDialogCursor, SessionDialogRequest, SessionDialogScope, Tui, TuiPresentation,
...
use bootstrap::{ProviderSource, effective_max_iterations};
