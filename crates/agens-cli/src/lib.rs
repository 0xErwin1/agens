...
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use agens_tui::TuiSubmissionOutcome;
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
...
use test_support::{
    ...
    native_batch_call, open_tui_palette_dialog, persist_tui_session, persist_tui_session_metadata,
    render_tui_test_backend, rotation_agent, rotation_dispatcher, run_production_batch,
    run_production_batch_with_policy, tui_project, tui_session_bootstrap, tui_session_directory,
