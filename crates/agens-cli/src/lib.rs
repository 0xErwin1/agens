...
use agens_core::{
    ...
    HeadlessToolOutput, HeadlessTurnPortError, PermissionDecision, PermissionPattern,
...
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use agens_tui::{TuiExecutionEvent, TuiPermissionBridge, TuiPermissionReply, TuiSubagentEvent};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
...
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use permissions::SharedToolDispatcher;
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use permissions::{
    PermissionPromptAnswer, PermissionPrompter, ProductionPermissionGate,
    ProductionPermissionResolver, ProductionPromptAuthorization, permission_policy,
...
// calls these unqualified. Remove this re-export once the test module moves.
use test_support::{
    BatchTool, ProductionBatchInput, RecordingPrompt, batch_call, bootstrap_from_configuration,
    native_batch_call, reset_tui_resume_test_counters, run_production_batch,
...
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use tools::task::{production_tui_task_runtime, production_tui_task_runtime_with_runner};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use tui::agents::{
...
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use tui::metrics::TuiMetricsPublisher;
