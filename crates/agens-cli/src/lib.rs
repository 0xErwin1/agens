...
use agens_core::{
    HeadlessTurnCancellation, HeadlessTurnError, Message, MessagePart, RetryBoundary,
    SessionAttemptStatus,
};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use agens_core::{PermissionMode, TurnProgressSink};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
...
use dispatch::{
    ...
    TuiSelectedTaskLaunch, launch_selected_tui_task, origin_launches_selected_subagent,
...
use permissions::{
    ...
    permission_policy, production_tui_permission_bridge, render_permission_prompt,
};
use permissions::{ParseToolInput, SharedToolDispatcher};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls this unqualified. Remove this re-export once the test module moves.
...
// calls these unqualified. Remove this re-export once the test module moves.
use session::attempt::{
    AttemptActivityRegistry, AttemptLifecycleError, ExplicitAttemptRecoveryOutcome,
    attempt_failure_status, recover_session_attempt_lifecycle, run_session_attempt_lifecycle,
...
use tools::runtime::{
    ...
    production_tool_runtime, production_tool_runtime_with_task_runner, task_execution_limits,
};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
...
use tui::run_tui;
use tui::session::{ActiveAgentRuntime, ResumeDraft, TuiSessionContext, resume_retry_notice};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use tui::session::{AgentRotationError, current_session_timestamp, rotate_active_agent};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls these unqualified. Remove this re-export once the test module moves.
use tui::session::{
    CompletedSubagentTurn, TuiSessionMutationError, reset_tui_session, session_dialog_entry,
    session_relative_age,
};
#[cfg(test)]
// Scaffolding for Phase 3: `mod tests` still opens with `use super::*;` and
// calls this unqualified. Remove this re-export once the test module moves.
