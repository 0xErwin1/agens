//! A bounded, ordered, cancellable publish channel.
//!
//! Communication is not owned by any layer: the runtime publishes, a terminal or
//! a daemon or a test consumes. The channel is generic over what travels on it
//! and knows nothing about either end.
